...
export function useFilters() {
  ...
  const hasActiveFilters = computed(() =>
    dateFrom.value !== null || dateTo.value !== null || selectedArtist.value !== null
  );
  ...
  return { dateFrom, dateTo, selectedArtist, sortBy, limit, activeFilters, hasActiveFilters, resetFilters };
}
